...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Dtcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"dtcointools.com", "192.168.1.36"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"dtcointools.com", "testnet-seed.dtcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Dtcoin is probably already running."), addrBind.ToString().c_str());
        else
